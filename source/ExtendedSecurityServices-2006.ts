...
let _cached_decoder_for_ContentIdentifier: __utils.ASN1Decoder<ContentIdentifier> | null = null;
let _cached_encoder_for_ContentIdentifier: __utils.ASN1Encoder<ContentIdentifier> | null = null;
export function _decode_ContentIdentifier (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ContentIdentifier) { _cached_decoder_for_ContentIdentifier = __utils._decodeOctetString; }
    return _cached_decoder_for_ContentIdentifier(el);
}
export function _encode_ContentIdentifier (value: ContentIdentifier, elGetter: __utils.ASN1Encoder<ContentIdentifier>) {
    if (!_cached_encoder_for_ContentIdentifier) { _cached_encoder_for_ContentIdentifier = __utils._encodeOctetString; }
...
let _cached_decoder_for_AllOrFirstTier: __utils.ASN1Decoder<AllOrFirstTier> | null = null;
let _cached_encoder_for_AllOrFirstTier: __utils.ASN1Encoder<AllOrFirstTier> | null = null;
export function _decode_AllOrFirstTier (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_AllOrFirstTier) { _cached_decoder_for_AllOrFirstTier = __utils._decodeInteger; }
    return _cached_decoder_for_AllOrFirstTier(el);
}
export function _encode_AllOrFirstTier (value: AllOrFirstTier, elGetter: __utils.ASN1Encoder<AllOrFirstTier>) {
    if (!_cached_encoder_for_AllOrFirstTier) { _cached_encoder_for_AllOrFirstTier = __utils._encodeInteger; }
...
let _cached_decoder_for_ReceiptsFrom: __utils.ASN1Decoder<ReceiptsFrom> | null = null;
let _cached_encoder_for_ReceiptsFrom: __utils.ASN1Encoder<ReceiptsFrom> | null = null;
export function _decode_ReceiptsFrom (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ReceiptsFrom) { _cached_decoder_for_ReceiptsFrom = __utils._decode_inextensible_choice<ReceiptsFrom>({
    "CONTEXT 0": [ "allOrFirstTier", __utils._decode_implicit<AllOrFirstTier>(() => _decode_AllOrFirstTier) ],
    "CONTEXT 1": [ "receiptList", __utils._decode_implicit<GeneralNames[]>(() => __utils._decodeSequenceOf<GeneralNames>(() => _decode_GeneralNames)) ]
}); }
    return _cached_decoder_for_ReceiptsFrom(el);
}
export function _encode_ReceiptsFrom (value: ReceiptsFrom, elGetter: __utils.ASN1Encoder<ReceiptsFrom>) {
    if (!_cached_encoder_for_ReceiptsFrom) { _cached_encoder_for_ReceiptsFrom = __utils._encode_choice<ReceiptsFrom>({
    "allOrFirstTier": __utils._encode_implicit(asn1.ASN1TagClass.context, 0, () => _encode_AllOrFirstTier, __utils.BER),
    "receiptList": __utils._encode_implicit(asn1.ASN1TagClass.context, 1, () => __utils._encodeSequenceOf<GeneralNames>(() => _encode_GeneralNames, __utils.BER), __utils.BER),
}, __utils.BER); }
...
export const _root_component_type_list_1_spec_for_ReceiptRequest: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("signedContentIdentifier", false, __utils.hasTag(asn1.ASN1TagClass.universal, 4), undefined, undefined),
    new __utils.ComponentSpec("receiptsFrom", false, __utils.hasAnyTag, undefined, undefined),
    new __utils.ComponentSpec("receiptsTo", false, __utils.hasTag(asn1.ASN1TagClass.universal, 16), undefined, undefined)
];
...
let _cached_decoder_for_ReceiptRequest: __utils.ASN1Decoder<ReceiptRequest> | null = null;
let _cached_encoder_for_ReceiptRequest: __utils.ASN1Encoder<ReceiptRequest> | null = null;
export function _decode_ReceiptRequest (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ReceiptRequest) { _cached_decoder_for_ReceiptRequest = function (el: asn1.ASN1Element): ReceiptRequest {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 3) {
        throw new asn1.ASN1ConstructionError("ReceiptRequest contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    ...
    receiptsTo = __utils._decodeSequenceOf<GeneralNames>(() => _decode_GeneralNames)(sequence[2]);
...
export function _encode_ReceiptRequest (value: ReceiptRequest, elGetter: __utils.ASN1Encoder<ReceiptRequest>) {
    if (!_cached_encoder_for_ReceiptRequest) { _cached_encoder_for_ReceiptRequest = function (value: ReceiptRequest, elGetter: __utils.ASN1Encoder<ReceiptRequest>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_ContentIdentifier(value.signedContentIdentifier, __utils.BER),
            /* REQUIRED   */ _encode_ReceiptsFrom(value.receiptsFrom, __utils.BER),
            /* REQUIRED   */ __utils._encodeSequenceOf<GeneralNames>(() => _encode_GeneralNames, __utils.BER)(value.receiptsTo, __utils.BER)
        ],
...
let _cached_decoder_for_ESSVersion: __utils.ASN1Decoder<ESSVersion> | null = null;
let _cached_encoder_for_ESSVersion: __utils.ASN1Encoder<ESSVersion> | null = null;
export function _decode_ESSVersion (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ESSVersion) { _cached_decoder_for_ESSVersion = __utils._decodeInteger; }
    return _cached_decoder_for_ESSVersion(el);
}
export function _encode_ESSVersion (value: ESSVersion, elGetter: __utils.ASN1Encoder<ESSVersion>) {
    if (!_cached_encoder_for_ESSVersion) { _cached_encoder_for_ESSVersion = __utils._encodeInteger; }
...
export const _root_component_type_list_1_spec_for_Receipt: __utils.ComponentSpec[] = [
    ...
    new __utils.ComponentSpec("signedContentIdentifier", false, __utils.hasTag(asn1.ASN1TagClass.universal, 4), undefined, undefined),
    new __utils.ComponentSpec("originatorSignatureValue", false, __utils.hasTag(asn1.ASN1TagClass.universal, 4), undefined, undefined)
];
...
export function _decode_Receipt (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_Receipt) { _cached_decoder_for_Receipt = function (el: asn1.ASN1Element): Receipt {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 4) {
        throw new asn1.ASN1ConstructionError("Receipt contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
...
export function _encode_Receipt (value: Receipt, elGetter: __utils.ASN1Encoder<Receipt>) {
    if (!_cached_encoder_for_Receipt) { _cached_encoder_for_Receipt = function (value: Receipt, elGetter: __utils.ASN1Encoder<Receipt>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_ESSVersion(value.version, __utils.BER),
            /* REQUIRED   */ _encode_ContentType(value.contentType, __utils.BER),
            /* REQUIRED   */ _encode_ContentIdentifier(value.signedContentIdentifier, __utils.BER),
            /* REQUIRED   */ __utils._encodeOctetString(value.originatorSignatureValue, __utils.BER)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
}; }
...
export const _root_component_type_list_1_spec_for_ContentHints: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("contentDescription", true, __utils.hasTag(asn1.ASN1TagClass.universal, 12), undefined, undefined),
    new __utils.ComponentSpec("contentType", false, __utils.hasTag(asn1.ASN1TagClass.universal, 6), undefined, undefined)
];
...
let _cached_decoder_for_ContentHints: __utils.ASN1Decoder<ContentHints> | null = null;
let _cached_encoder_for_ContentHints: __utils.ASN1Encoder<ContentHints> | null = null;
export function _decode_ContentHints (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ContentHints) { _cached_decoder_for_ContentHints = function (el: asn1.ASN1Element): ContentHints {
    ...
    const callbacks: __utils.DecodingMap = {
        "contentDescription": (_el: asn1.ASN1Element): void => { contentDescription = __utils._decodeUTF8String(_el); },
...
export function _encode_ContentHints (value: ContentHints, elGetter: __utils.ASN1Encoder<ContentHints>) {
    if (!_cached_encoder_for_ContentHints) { _cached_encoder_for_ContentHints = function (value: ContentHints, elGetter: __utils.ASN1Encoder<ContentHints>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* IF_ABSENT  */ ((value.contentDescription === undefined) ? undefined : __utils._encodeUTF8String(value.contentDescription, __utils.BER)),
            /* REQUIRED   */ _encode_ContentType(value.contentType, __utils.BER)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
}; }
...
let _cached_decoder_for_MsgSigDigest: __utils.ASN1Decoder<MsgSigDigest> | null = null;
let _cached_encoder_for_MsgSigDigest: __utils.ASN1Encoder<MsgSigDigest> | null = null;
export function _decode_MsgSigDigest (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_MsgSigDigest) { _cached_decoder_for_MsgSigDigest = __utils._decodeOctetString; }
    return _cached_decoder_for_MsgSigDigest(el);
}
export function _encode_MsgSigDigest (value: MsgSigDigest, elGetter: __utils.ASN1Encoder<MsgSigDigest>) {
    if (!_cached_encoder_for_MsgSigDigest) { _cached_encoder_for_MsgSigDigest = __utils._encodeOctetString; }
...
let _cached_decoder_for_ContentReference: __utils.ASN1Decoder<ContentReference> | null = null;
let _cached_encoder_for_ContentReference: __utils.ASN1Encoder<ContentReference> | null = null;
export function _decode_ContentReference (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ContentReference) { _cached_decoder_for_ContentReference = function (el: asn1.ASN1Element): ContentReference {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 3) {
        throw new asn1.ASN1ConstructionError("ContentReference contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
...
export function _encode_ContentReference (value: ContentReference, elGetter: __utils.ASN1Encoder<ContentReference>) {
    if (!_cached_encoder_for_ContentReference) { _cached_encoder_for_ContentReference = function (value: ContentReference, elGetter: __utils.ASN1Encoder<ContentReference>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_ContentType(value.contentType, __utils.BER),
            /* REQUIRED   */ _encode_ContentIdentifier(value.signedContentIdentifier, __utils.BER),
...
let _cached_decoder_for_SecurityPolicyIdentifier: __utils.ASN1Decoder<SecurityPolicyIdentifier> | null = null;
let _cached_encoder_for_SecurityPolicyIdentifier: __utils.ASN1Encoder<SecurityPolicyIdentifier> | null = null;
export function _decode_SecurityPolicyIdentifier (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_SecurityPolicyIdentifier) { _cached_decoder_for_SecurityPolicyIdentifier = __utils._decodeObjectIdentifier; }
    return _cached_decoder_for_SecurityPolicyIdentifier(el);
}
export function _encode_SecurityPolicyIdentifier (value: SecurityPolicyIdentifier, elGetter: __utils.ASN1Encoder<SecurityPolicyIdentifier>) {
    if (!_cached_encoder_for_SecurityPolicyIdentifier) { _cached_encoder_for_SecurityPolicyIdentifier = __utils._encodeObjectIdentifier; }
...
let _cached_decoder_for_SecurityClassification: __utils.ASN1Decoder<SecurityClassification> | null = null;
let _cached_encoder_for_SecurityClassification: __utils.ASN1Encoder<SecurityClassification> | null = null;
export function _decode_SecurityClassification (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_SecurityClassification) { _cached_decoder_for_SecurityClassification = __utils._decodeInteger; }
    return _cached_decoder_for_SecurityClassification(el);
}
export function _encode_SecurityClassification (value: SecurityClassification, elGetter: __utils.ASN1Encoder<SecurityClassification>) {
    if (!_cached_encoder_for_SecurityClassification) { _cached_encoder_for_SecurityClassification = __utils._encodeInteger; }
...
let _cached_decoder_for_ESSPrivacyMark: __utils.ASN1Decoder<ESSPrivacyMark> | null = null;
let _cached_encoder_for_ESSPrivacyMark: __utils.ASN1Encoder<ESSPrivacyMark> | null = null;
export function _decode_ESSPrivacyMark (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ESSPrivacyMark) { _cached_decoder_for_ESSPrivacyMark = __utils._decode_inextensible_choice<ESSPrivacyMark>({
...
export function _encode_ESSPrivacyMark (value: ESSPrivacyMark, elGetter: __utils.ASN1Encoder<ESSPrivacyMark>) {
    if (!_cached_encoder_for_ESSPrivacyMark) { _cached_encoder_for_ESSPrivacyMark = __utils._encode_choice<ESSPrivacyMark>({
...
export function _decode_SecurityCategory (el: asn1.ASN1Element) {
    ...
    value = __utils._decode_implicit<asn1.ASN1Element>(() => __utils._decodeAny)(sequence[1]);
...
export function _encode_SecurityCategory (value: SecurityCategory, elGetter: __utils.ASN1Encoder<SecurityCategory>) {
    ...
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ...
            /* REQUIRED   */ __utils._encode_implicit(asn1.ASN1TagClass.context, 1, () => __utils._encodeAny, __utils.BER)(value.value, __utils.BER)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
}; }
...
let _cached_decoder_for_SecurityCategories: __utils.ASN1Decoder<SecurityCategories> | null = null;
let _cached_encoder_for_SecurityCategories: __utils.ASN1Encoder<SecurityCategories> | null = null;
export function _decode_SecurityCategories (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_SecurityCategories) { _cached_decoder_for_SecurityCategories = __utils._decodeSetOf<SecurityCategory>(() => _decode_SecurityCategory); }
    return _cached_decoder_for_SecurityCategories(el);
}
export function _encode_SecurityCategories (value: SecurityCategories, elGetter: __utils.ASN1Encoder<SecurityCategories>) {
    if (!_cached_encoder_for_SecurityCategories) { _cached_encoder_for_SecurityCategories = __utils._encodeSetOf<SecurityCategory>(() => _encode_SecurityCategory, __utils.BER); }
...
export const _root_component_type_list_1_spec_for_ESSSecurityLabel: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("security-policy-identifier", false, __utils.hasTag(asn1.ASN1TagClass.universal, 6), undefined, undefined),
    new __utils.ComponentSpec("security-classification", true, __utils.hasTag(asn1.ASN1TagClass.universal, 2), undefined, undefined),
    new __utils.ComponentSpec("privacy-mark", true, __utils.hasAnyTag, undefined, undefined),
...
let _cached_decoder_for_ESSSecurityLabel: __utils.ASN1Decoder<ESSSecurityLabel> | null = null;
let _cached_encoder_for_ESSSecurityLabel: __utils.ASN1Encoder<ESSSecurityLabel> | null = null;
export function _decode_ESSSecurityLabel (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ESSSecurityLabel) { _cached_decoder_for_ESSSecurityLabel = function (el: asn1.ASN1Element): ESSSecurityLabel {
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "privacy-mark": (_el: asn1.ASN1Element): void => { privacy_mark = _decode_ESSPrivacyMark(_el); },
...
export function _encode_ESSSecurityLabel (value: ESSSecurityLabel, elGetter: __utils.ASN1Encoder<ESSSecurityLabel>) {
    if (!_cached_encoder_for_ESSSecurityLabel) { _cached_encoder_for_ESSSecurityLabel = function (value: ESSSecurityLabel, elGetter: __utils.ASN1Encoder<ESSSecurityLabel>): asn1.ASN1Element {
    return __utils._encodeSet(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_SecurityPolicyIdentifier(value.security_policy_identifier, __utils.BER),
            /* IF_ABSENT  */ ((value.security_classification === undefined) ? undefined : _encode_SecurityClassification(value.security_classification, __utils.BER)),
            /* IF_ABSENT  */ ((value.privacy_mark === undefined) ? undefined : _encode_ESSPrivacyMark(value.privacy_mark, __utils.BER)),
            /* IF_ABSENT  */ ((value.security_categories === undefined) ? undefined : _encode_SecurityCategories(value.security_categories, __utils.BER))
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
}; }
...
let _cached_decoder_for_EquivalentLabels: __utils.ASN1Decoder<EquivalentLabels> | null = null;
let _cached_encoder_for_EquivalentLabels: __utils.ASN1Encoder<EquivalentLabels> | null = null;
export function _decode_EquivalentLabels (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_EquivalentLabels) { _cached_decoder_for_EquivalentLabels = __utils._decodeSequenceOf<ESSSecurityLabel>(() => _decode_ESSSecurityLabel); }
    return _cached_decoder_for_EquivalentLabels(el);
}
export function _encode_EquivalentLabels (value: EquivalentLabels, elGetter: __utils.ASN1Encoder<EquivalentLabels>) {
    if (!_cached_encoder_for_EquivalentLabels) { _cached_encoder_for_EquivalentLabels = __utils._encodeSequenceOf<ESSSecurityLabel>(() => _encode_ESSSecurityLabel, __utils.BER); }
...
let _cached_decoder_for_EntityIdentifier: __utils.ASN1Decoder<EntityIdentifier> | null = null;
let _cached_encoder_for_EntityIdentifier: __utils.ASN1Encoder<EntityIdentifier> | null = null;
export function _decode_EntityIdentifier (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_EntityIdentifier) { _cached_decoder_for_EntityIdentifier = __utils._decode_inextensible_choice<EntityIdentifier>({
...
export function _encode_EntityIdentifier (value: EntityIdentifier, elGetter: __utils.ASN1Encoder<EntityIdentifier>) {
    if (!_cached_encoder_for_EntityIdentifier) { _cached_encoder_for_EntityIdentifier = __utils._encode_choice<EntityIdentifier>({
...
let _cached_decoder_for_MLReceiptPolicy: __utils.ASN1Decoder<MLReceiptPolicy> | null = null;
let _cached_encoder_for_MLReceiptPolicy: __utils.ASN1Encoder<MLReceiptPolicy> | null = null;
export function _decode_MLReceiptPolicy (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_MLReceiptPolicy) { _cached_decoder_for_MLReceiptPolicy = __utils._decode_inextensible_choice<MLReceiptPolicy>({
    "CONTEXT 0": [ "none", __utils._decode_implicit<asn1.NULL>(() => __utils._decodeNull) ],
    "CONTEXT 1": [ "insteadOf", __utils._decode_implicit<GeneralNames[]>(() => __utils._decodeSequenceOf<GeneralNames>(() => _decode_GeneralNames)) ],
    "CONTEXT 2": [ "inAdditionTo", __utils._decode_implicit<GeneralNames[]>(() => __utils._decodeSequenceOf<GeneralNames>(() => _decode_GeneralNames)) ]
}); }
    return _cached_decoder_for_MLReceiptPolicy(el);
}
export function _encode_MLReceiptPolicy (value: MLReceiptPolicy, elGetter: __utils.ASN1Encoder<MLReceiptPolicy>) {
    if (!_cached_encoder_for_MLReceiptPolicy) { _cached_encoder_for_MLReceiptPolicy = __utils._encode_choice<MLReceiptPolicy>({
    "none": __utils._encode_implicit(asn1.ASN1TagClass.context, 0, () => __utils._encodeNull, __utils.BER),
    "insteadOf": __utils._encode_implicit(asn1.ASN1TagClass.context, 1, () => __utils._encodeSequenceOf<GeneralNames>(() => _encode_GeneralNames, __utils.BER), __utils.BER),
    "inAdditionTo": __utils._encode_implicit(asn1.ASN1TagClass.context, 2, () => __utils._encodeSequenceOf<GeneralNames>(() => _encode_GeneralNames, __utils.BER), __utils.BER),
}, __utils.BER); }
...
export const _root_component_type_list_1_spec_for_MLData: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("mailListIdentifier", false, __utils.hasAnyTag, undefined, undefined),
    new __utils.ComponentSpec("expansionTime", false, __utils.hasTag(asn1.ASN1TagClass.universal, 24), undefined, undefined),
    new __utils.ComponentSpec("mlReceiptPolicy", true, __utils.hasAnyTag, undefined, undefined)
];
...
export function _decode_MLData (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_MLData) { _cached_decoder_for_MLData = function (el: asn1.ASN1Element): MLData {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "mailListIdentifier": (_el: asn1.ASN1Element): void => { mailListIdentifier = _decode_EntityIdentifier(_el); },
        "expansionTime": (_el: asn1.ASN1Element): void => { expansionTime = __utils._decodeGeneralizedTime(_el); },
        "mlReceiptPolicy": (_el: asn1.ASN1Element): void => { mlReceiptPolicy = _decode_MLReceiptPolicy(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export function _encode_MLData (value: MLData, elGetter: __utils.ASN1Encoder<MLData>) {
    if (!_cached_encoder_for_MLData) { _cached_encoder_for_MLData = function (value: MLData, elGetter: __utils.ASN1Encoder<MLData>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_EntityIdentifier(value.mailListIdentifier, __utils.BER),
            /* REQUIRED   */ __utils._encodeGeneralizedTime(value.expansionTime, __utils.BER),
            /* IF_ABSENT  */ ((value.mlReceiptPolicy === undefined) ? undefined : _encode_MLReceiptPolicy(value.mlReceiptPolicy, __utils.BER))
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
}; }
...
let _cached_decoder_for_MLExpansionHistory: __utils.ASN1Decoder<MLExpansionHistory> | null = null;
let _cached_encoder_for_MLExpansionHistory: __utils.ASN1Encoder<MLExpansionHistory> | null = null;
export function _decode_MLExpansionHistory (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_MLExpansionHistory) { _cached_decoder_for_MLExpansionHistory = __utils._decodeSequenceOf<MLData>(() => _decode_MLData); }
    return _cached_decoder_for_MLExpansionHistory(el);
}
export function _encode_MLExpansionHistory (value: MLExpansionHistory, elGetter: __utils.ASN1Encoder<MLExpansionHistory>) {
    if (!_cached_encoder_for_MLExpansionHistory) { _cached_encoder_for_MLExpansionHistory = __utils._encodeSequenceOf<MLData>(() => _encode_MLData, __utils.BER); }
...
export function _decode_Hash (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_Hash) { _cached_decoder_for_Hash = __utils._decodeOctetString; }
    return _cached_decoder_for_Hash(el);
}
export function _encode_Hash (value: Hash, elGetter: __utils.ASN1Encoder<Hash>) {
    if (!_cached_encoder_for_Hash) { _cached_encoder_for_Hash = __utils._encodeOctetString; }
...
export function _decode_IssuerSerial (el: asn1.ASN1Element) {
    ...
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("IssuerSerial contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
...
export const _root_component_type_list_1_spec_for_ESSCertID: __utils.ComponentSpec[] = [
    ...
    new __utils.ComponentSpec("issuerSerial", true, __utils.hasTag(asn1.ASN1TagClass.universal, 16), undefined, undefined)
];
...
export function _decode_ESSCertID (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ESSCertID) { _cached_decoder_for_ESSCertID = function (el: asn1.ASN1Element): ESSCertID {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    let certHash!: Hash;
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "certHash": (_el: asn1.ASN1Element): void => { certHash = _decode_Hash(_el); },
        "issuerSerial": (_el: asn1.ASN1Element): void => { issuerSerial = _decode_IssuerSerial(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export function _encode_ESSCertID (value: ESSCertID, elGetter: __utils.ASN1Encoder<ESSCertID>) {
    if (!_cached_encoder_for_ESSCertID) { _cached_encoder_for_ESSCertID = function (value: ESSCertID, elGetter: __utils.ASN1Encoder<ESSCertID>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_Hash(value.certHash, __utils.BER),
            /* IF_ABSENT  */ ((value.issuerSerial === undefined) ? undefined : _encode_IssuerSerial(value.issuerSerial, __utils.BER))
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
}; }
...
export const _root_component_type_list_1_spec_for_SigningCertificate: __utils.ComponentSpec[] = [
    ...
    new __utils.ComponentSpec("policies", true, __utils.hasTag(asn1.ASN1TagClass.universal, 16), undefined, undefined)
];
...
let _cached_decoder_for_SigningCertificate: __utils.ASN1Decoder<SigningCertificate> | null = null;
let _cached_encoder_for_SigningCertificate: __utils.ASN1Encoder<SigningCertificate> | null = null;
export function _decode_SigningCertificate (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_SigningCertificate) { _cached_decoder_for_SigningCertificate = function (el: asn1.ASN1Element): SigningCertificate {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    let certs!: ESSCertID[];
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "certs": (_el: asn1.ASN1Element): void => { certs = __utils._decodeSequenceOf<ESSCertID>(() => _decode_ESSCertID)(_el); },
        "policies": (_el: asn1.ASN1Element): void => { policies = __utils._decodeSequenceOf<PolicyInformation>(() => _decode_PolicyInformation)(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export function _encode_SigningCertificate (value: SigningCertificate, elGetter: __utils.ASN1Encoder<SigningCertificate>) {
    if (!_cached_encoder_for_SigningCertificate) { _cached_encoder_for_SigningCertificate = function (value: SigningCertificate, elGetter: __utils.ASN1Encoder<SigningCertificate>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ __utils._encodeSequenceOf<ESSCertID>(() => _encode_ESSCertID, __utils.BER)(value.certs, __utils.BER),
            /* IF_ABSENT  */ ((value.policies === undefined) ? undefined : __utils._encodeSequenceOf<PolicyInformation>(() => _encode_PolicyInformation, __utils.BER)(value.policies, __utils.BER))
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
}; }
...
let _cached_decoder_for_ESSCertIDv2: __utils.ASN1Decoder<ESSCertIDv2> | null = null;
let _cached_encoder_for_ESSCertIDv2: __utils.ASN1Encoder<ESSCertIDv2> | null = null;
export function _decode_ESSCertIDv2 (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ESSCertIDv2) { _cached_decoder_for_ESSCertIDv2 = function (el: asn1.ASN1Element): ESSCertIDv2 {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    let hashAlgorithm: asn1.OPTIONAL<AlgorithmIdentifier> = ESSCertIDv2._default_value_for_hashAlgorithm;
    let certHash!: Hash;
    let issuerSerial: asn1.OPTIONAL<IssuerSerial>;
    /* END_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "hashAlgorithm": (_el: asn1.ASN1Element): void => { hashAlgorithm = _decode_AlgorithmIdentifier(_el); },
        "certHash": (_el: asn1.ASN1Element): void => { certHash = _decode_Hash(_el); },
        "issuerSerial": (_el: asn1.ASN1Element): void => { issuerSerial = _decode_IssuerSerial(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
...
export function _encode_ESSCertIDv2 (value: ESSCertIDv2, elGetter: __utils.ASN1Encoder<ESSCertIDv2>) {
    if (!_cached_encoder_for_ESSCertIDv2) { _cached_encoder_for_ESSCertIDv2 = function (value: ESSCertIDv2, elGetter: __utils.ASN1Encoder<ESSCertIDv2>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* IF_DEFAULT */ (value.hashAlgorithm === undefined || __utils.deepEq(value.hashAlgorithm, ESSCertIDv2._default_value_for_hashAlgorithm) ? undefined : _encode_AlgorithmIdentifier(value.hashAlgorithm, __utils.BER)),
            /* REQUIRED   */ _encode_Hash(value.certHash, __utils.BER),
            /* IF_ABSENT  */ ((value.issuerSerial === undefined) ? undefined : _encode_IssuerSerial(value.issuerSerial, __utils.BER))
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
...
let _cached_decoder_for_SigningCertificateV2: __utils.ASN1Decoder<SigningCertificateV2> | null = null;
let _cached_encoder_for_SigningCertificateV2: __utils.ASN1Encoder<SigningCertificateV2> | null = null;
export function _decode_SigningCertificateV2 (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_SigningCertificateV2) { _cached_decoder_for_SigningCertificateV2 = function (el: asn1.ASN1Element): SigningCertificateV2 {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "certs": (_el: asn1.ASN1Element): void => { certs = __utils._decodeSequenceOf<ESSCertIDv2>(() => _decode_ESSCertIDv2)(_el); },
        "policies": (_el: asn1.ASN1Element): void => { policies = __utils._decodeSequenceOf<PolicyInformation>(() => _decode_PolicyInformation)(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export function _encode_SigningCertificateV2 (value: SigningCertificateV2, elGetter: __utils.ASN1Encoder<SigningCertificateV2>) {
    if (!_cached_encoder_for_SigningCertificateV2) { _cached_encoder_for_SigningCertificateV2 = function (value: SigningCertificateV2, elGetter: __utils.ASN1Encoder<SigningCertificateV2>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ __utils._encodeSequenceOf<ESSCertIDv2>(() => _encode_ESSCertIDv2, __utils.BER)(value.certs, __utils.BER),
            /* IF_ABSENT  */ ((value.policies === undefined) ? undefined : __utils._encodeSequenceOf<PolicyInformation>(() => _encode_PolicyInformation, __utils.BER)(value.policies, __utils.BER))
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
}; }
